...
us_cvd_sp_data_euc <- st_transform(st_centroid(us_cvd_sp_data), 4326)

LC_metro1_euc <- st_transform(st_centroid(LC_metro1), 4326)

cen_dist_matrix <- st_distance(x=us_cvd_sp_data_euc, y=LC_metro1_euc, which = "Great Circle")
