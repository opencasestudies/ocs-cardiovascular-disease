...
We convert to square miles using a constant provided by the US Census Bureau [here](https://www.census.gov/quickfacts/fact/note/US/LND110210). 
...
us_cvd_sp_data <- us_cvd_sp_data %>%
  mutate(Pop_dens=Population/(ALAND/2589988)) 
```
